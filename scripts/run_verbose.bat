...
REM Start the container in attached mode with logs in a separate console (non-blocking)
start "Starting n8n" cmd /k "docker compose -f n8n-docker-compose.yaml --env-file .env up"
